...
 
known = """
price lyrics close scrub afraid van 
friend sorry lizard denial capital 
flame destroy cattle dish useless 
table send hybrid plunge argue 
barely crew above energy
"""
 
...
 
 
def has_algos(addr):WTL2V2M6C27TEOHECU6NRGNL3PCZSCS3UPXFRYIXTHVVTCDYTZRTV77RUM
    import explore
    explore.active(addr)
 
 
